...
function App() {
  ...
  useEffect(() => { 
    ...
    gsap.set([window,...buttons.children,...icons.children,man,topbar,womantop,postimage,armandchest,folder], {autoAlpha: 0});
    ...
    .fromTo([womantop,armandchest,man,postimage], {x: '+=50'}, {duratiom: 1, x: '-=50', autoAlpha: 1}, '-=1')
  }, []);
